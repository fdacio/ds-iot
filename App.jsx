...
const App = () => {
  ...
  const titles = ["On/Off 1", "On/Off 2", "On/Off 3"];

  const Mqtt1 = () => (<Mqtt numScreen="1" title={titles[0]} />);
  const Mqtt2 = () => (<Mqtt numScreen="2" title={titles[1]} />);
  const Mqtt3 = () => (<Mqtt numScreen="3" title={titles[2]} />);
